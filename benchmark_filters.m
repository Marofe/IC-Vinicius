...
addLibrary('inslib');
if exist('SPUKF_Lie', 'dir')
    addLibrary('SPUKF_Lie');
end
if exist('SRUKF_Lie', 'dir')
    addLibrary('SRUKF_Lie');
end
...
elseif exist('SPUKF_Lie', 'dir')
    disp('  [3] SPUKF_Lie');
    disp('  [4] All Available Filters');
else
    disp('  [3] All Available Filters (EKF_Lie & UKF_Lie)');
end

try; filt_choice = input('Enter your choice: ', 's'); catch; filt_choice = '4'; end
if isempty(filt_choice), filt_choice = '4'; end

all_filters = {'EKF_Lie', 'UKF_Lie'};
if exist('SRUKF_Lie', 'dir'), all_filters{end+1} = 'SRUKF_Lie'; end
if exist('SPUKF_Lie', 'dir'), all_filters{end+1} = 'SPUKF_Lie'; end

filters = {};
if contains(filt_choice, '1'), filters{end+1} = 'EKF_Lie'; end
if contains(filt_choice, '2'), filters{end+1} = 'UKF_Lie'; end
if contains(filt_choice, '3')
    if exist('SRUKF_Lie', 'dir')
...
if contains(filt_choice, '4') || isempty(filters)
    filters = all_filters;
end
