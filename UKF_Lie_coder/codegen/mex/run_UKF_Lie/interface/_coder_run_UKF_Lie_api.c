...
static real_T (*nb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                    const emlrtMsgIdentifier *msgId))[3408];
...
static real_T (*t_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                   const emlrtMsgIdentifier *parentId))[3408];
...
static real_T (*w_emlrt_marshallIn(const emlrtStack *sp, const mxArray *nullptr,
...
static void y_emlrt_marshallIn(const emlrtStack *sp, const mxArray *nullptr,
...
static real_T (*nb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                    const emlrtMsgIdentifier *msgId))[3408]
{
  static const int32_T dims[2] = {3, 1136};
  real_T(*ret)[3408];
  int32_T b_iv[2];
  boolean_T bv[2] = {false, false};
  emlrtCheckVsBuiltInR2012b((emlrtConstCTX)sp, msgId, src, "double", false, 2U,
                            (const void *)&dims[0], &bv[0], &b_iv[0]);
  ret = (real_T(*)[3408])emlrtMxGetData(src);
  emlrtDestroyArray(&src);
  return ret;
}
                                   ...
                                   const char_T *identifier))[687816]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = x_emlrt_marshallIn(sp, emlrtAlias(nullptr), &thisId);
  emlrtDestroyArray(&nullptr);
  return y;
}
                               ...
                               const char_T *identifier, struct0_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  ab_emlrt_marshallIn(sp, emlrtAlias(nullptr), &thisId, y);
  emlrtDestroyArray(&nullptr);
}
                     ...
                     int32_T nlhs, const mxArray *plhs[4])
{
  ...
  euler = w_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_17), "euler");
  y_emlrt_marshallIn(&st, emlrtAliasP(prhs[18]), "ref", &SD->f2.ref);
