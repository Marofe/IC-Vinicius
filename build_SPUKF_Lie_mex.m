% Variable-dimension build script for run_SPUKF_Lie MEX compilation
...
% Matches: function [...] = run_SPUKF_Lie(N, time, gps_time, hx, trP, P, ...
...
codegen -config cfg run_SPUKF_Lie -args args;
